...
public:
	...
	/// All parameters are just guessed in a weak hope that they have sth to do with setting textures.
	/// The replacement suspends call to D3D, and accumulates calls in memory until the end of frame rendering.
	/// </summary>
